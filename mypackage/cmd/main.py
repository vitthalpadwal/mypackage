...
def show(args):
        print("Showing mypackage")

def set(args):
        print("Set Value for mypackage")
...
def main():
    ...
    cmd_show = subparsers.add_parser(
        'show', help='show the mypackage')
    cmd_show.set_defaults(func=show)

    cmd_set = subparsers.add_parser(
        'set', help='set the mypackage')
    cmd_set.set_defaults(func=set)
